 ...
 */
final class Version20220919140452 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE joke ADD author_id INT NOT NULL');
  ...
  public function down(Schema $schema): void
  {
    ...
    $this->addSql('DROP INDEX IDX_8D8563DDF675F31B');
    $this->addSql('ALTER TABLE joke DROP author_id');
  }
}
